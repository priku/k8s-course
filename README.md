...
**Part 1**
 - [x] **1.1** - Log Output: UUID generation with timestamps ([link](https://github.com/priku/k8s-course/tree/1.1))
 - [x] **1.2** - Todo Project: Basic HTTP server ([link](https://github.com/priku/k8s-course/tree/1.2))
 - [x] **1.3** - Log Output: Declarative Kubernetes deployment ([link](https://github.com/priku/k8s-course/tree/1.3))
 - [x] **1.4** - Todo Project: Declarative Kubernetes deployment ([link](https://github.com/priku/k8s-course/tree/1.4))
 - [x] **1.5** - Todo Project: HTTP server with HTML response ([link](https://github.com/priku/k8s-course/tree/1.5))
 - [x] **1.6** - Todo Project: NodePort Service ([link](https://github.com/priku/k8s-course/tree/1.6))
 - [x] **1.7** - Log Output: HTTP endpoint with Ingress ([link](https://github.com/priku/k8s-course/tree/1.7))
 - [x] **1.8** - Todo Project: Ingress configuration ([link](https://github.com/priku/k8s-course/tree/1.8))
 - [x] **1.9** - Ping-pong application with shared Ingress ([link](https://github.com/priku/k8s-course/tree/1.9))
 - [x] **1.10** - Log Output: Split into two containers ([link](https://github.com/priku/k8s-course/tree/1.10))
 - [x] **1.11** - Share data between applications with PersistentVolume ([link](https://github.com/priku/k8s-course/tree/1.11))
 - [x] **1.12** - Todo Project: Cached daily image from Lorem Picsum ([link](https://github.com/priku/k8s-course/tree/1.12))
 - [x] **1.13** - Todo Project: Todo list with input field, validation, and hardcoded todos ([link](https://github.com/priku/k8s-course/tree/1.13))
